...
Substituting the finite-difference expression for ``Δ^k`` (see [Finite differences](@extref)) we obtain
...
Substituting the finite-difference expression for ``∇^k`` (see [Finite differences](@extref)), we obtain
